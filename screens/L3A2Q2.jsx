    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ flexDirection: 'row',margin: 40 }}>
              <Text style={styles.instructionText}> ____</Text>
              <Text style={styles.instructionText}> ka</Text>
            ...
            <TouchableOpacity style={styles.buttonContainer} onPress={() => navigation.navigate('L3A2Q3')}>
...
const styles = StyleSheet.create({
  ...
  const L3A2Q2 = ({navigation}) => {
    ...
    const result = () => {
    if (verifyConcatenation(receivingItemList,'wiwatakan')){
        alert('Respuesta:\n'+'Correcto');
        resetLists();
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.subTitle}> Ordena las preguntas </Text>
                ...
                style={styles.buttonContainer}
                    onPress={() => {
                      if (currentButtonText === 'Verificar'){
                        ...
                        navigation.navigate('L3A2Q3',{puntuation2:puntaje})
