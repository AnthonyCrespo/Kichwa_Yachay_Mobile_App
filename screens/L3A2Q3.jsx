...
const L3A2Q3= ({navigation}) => {
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.buttonSolution}>  kanki </Text>

            <TouchableOpacity style={styles.buttonContainer} onPress={() => navigation.navigate('L3A2Q4')}>
